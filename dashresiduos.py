...
if st.session_state["authentication_status"]:
    ...
    if ordens_servico is not None:
        ...
        tipo_servico = ['Todos'] + sorted(ordens_servico['Tipo de Serviço'].dropna().unique().tolist())
        servico_selecionado = st.sidebar.selectbox("Tipo de Serviço", tipo_servico)
        todos_equipamentos = []
        ...
        st.plotly_chart(fig_evolucao, use_container_width=True, key="grafico_evolucao_mensal")
        ...
        if df_backlog.empty:
            ...
            st.plotly_chart(fig_backlog, use_container_width=True, key="grafico_backlog")
        ...
        st.plotly_chart(fig_sla, use_container_width=True, key="grafico_sla")
        ...
        if not df_filtrado.empty:
            ...
            with col1:
                ...
                st.plotly_chart(fig_colab, use_container_width=True, key="grafico_colaboradores")
            with col2:
            ...
            if not equipamentos_counts.empty:
                ...
                st.plotly_chart(fig_equip, use_container_width=True, key="grafico_equipamentos")
            else:
                    ...
                    with col1:
                        ...
                        if not df_falhas_filtrado.empty:
                            ...
                            if not falhas_counts.empty:
                                ...
                                st.plotly_chart(fig_falhas, use_container_width=True, key="grafico_falhas")
                            else:
                    ...
                    with col2:
                        ...
                        if not df_causas_filtrado.empty:
                            ...
                            if not causas_counts.empty:
                                ...
                                st.plotly_chart(fig_causas, use_container_width=True, key="grafico_causas")
                            else:
                    ...
                    with col3:
                        ...
                        if not df_acoes_filtrado.empty:
                            ...
                            if not acoes_counts.empty:
                                ...
                                st.plotly_chart(fig_acoes, use_container_width=True, key="grafico_acoes")
                            else:
                ...
                if recorrencia_data:
                    ...
                    with col1:
                        ...
                        if len(metricas_colaborador) > 0:
                            ...
                            st.plotly_chart(fig_media, use_container_width=True, key="grafico_media_recorrencias")
                    with col2:
                        ...
                        if len(metricas_colaborador) > 0:
                            ...
                            st.plotly_chart(fig_percent, use_container_width=True, key="grafico_percentual_recorrencia")
                    # RESUMO GERAL
                    ...
                    if st.checkbox("📅 Mostrar Análise Temporal de Recorrências"):
                        ...
                        st.plotly_chart(fig_temporal, use_container_width=True, key="grafico_evolucao_temporal")
                else:
        ...
        if not df_filtrado.empty:
            ...
            df_display = df_filtrado[[
                ...
                'status_final', 'data_conclusao', 'os_concluida', 'Tipo de Serviço', 'link'
            ]].copy()
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    "Tipo de Serviço": st.column_config.TextColumn(
                        "Tipo de Serviço",
